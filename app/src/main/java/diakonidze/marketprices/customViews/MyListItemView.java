...
public class MyListItemView extends ConstraintLayout {
    ...
    public MyListItemView(final Context context, final RealProduct realproduct, Boolean isChecked, final LinearLayout uncheckedConteiner, final LinearLayout checkedConteiner) {
        super(context);
...
//        this.isChecked = isChecked;
        ...
        checkBox.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                realproduct.setChecked(isChecked);
                ...
                if (isChecked) {
                    ...
                    MyListItemView copy = new MyListItemView(context, realproduct, true, uncheckedConteiner, checkedConteiner);
                    checkedConteiner.addView(copy);
                } else {
                    Log.d(TAG, "oncheck_click: 92");
                    tv_dasaxeleba.setPaintFlags(tv_dasaxeleba.getPaintFlags() & (~Paint.STRIKE_THRU_TEXT_FLAG));
                    checkedConteiner.removeView(getView());
                    MyListItemView copy = new MyListItemView(context, realproduct, false, uncheckedConteiner, checkedConteiner);
        ...
        btn_itemRemove.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                for (int i = 0; i < GlobalConstants.MY_SHOPING_LIST.size(); i++) {
                    if (GlobalConstants.MY_SHOPING_LIST.get(i).getId() == realproduct.getId()) {
    ...
    private void initView() {
        ...
        tv_dasaxeleba.setText(realProduct.getProduct().getName());
        tv_magazia.setText(realProduct.getMarketName());
        tv_price.setText(String.valueOf(realProduct.getPrice()));

        checkBox.setChecked(realProduct.getChecked());
        setState(realProduct.getChecked());
    }
